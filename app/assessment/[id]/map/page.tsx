...
export default function EntityIdMapPage() {
  ...
  return <>
    ...
    <div className="panel">
      ...
      <div className="form-actions"><a className="button button-secondary" href={`/assessment/${assessmentId}/diagnostics`}>Back to findings</a><a className="button button-secondary" href={`/assessment/${assessmentId}`}>Assessment workspace</a></div>
    </div>
  </>;
}
