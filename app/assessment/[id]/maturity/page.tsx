...
export default function MaturityRecommendationsPage() {
  ...
  return <>
    ...
    <div className="panel">
      ...
      <div className="form-actions"><a className="button button-secondary" href={`/assessment/${assessmentId}/map`}>Back to Entity/ID map</a><a className="button button-secondary" href={`/assessment/${assessmentId}`}>Assessment workspace</a></div>
    </div>
  </>;
}
